...
const BENEFITS = [
  { icon: "🛂", title: "Passport Renewals", desc: "Fast-tracked passport renewal assistance for UAE residents and international nationals." },
  { icon: "🏖️", title: "Tourist & Visit Visas", desc: "Short-stay visa processing for tourism, family visits, and leisure travel across 40+ destinations." },
  { icon: "💼", title: "Business Entry Visas", desc: "Business visit and multiple-entry visa applications for GCC and international travel." },
  { icon: "🚌", title: "Transit Permits", desc: "Transit visa and permit processing for stopovers requiring entry clearance." },
  { icon: "📄", title: "Long-Stay Visas", desc: "Extended stay visa applications for extended tourism, study, or work purposes." },
  { icon: "⚡", title: "Expedited Processing", desc: "Priority handling available for urgent travel — response times as fast as 24–48 hours." },
];

const STEPS = [
  { num: "01", title: "Consultation", desc: "We assess your travel requirements, nationality, and destination to determine the correct visa category.", duration: "Day 1" },
  { num: "02", title: "Document Checklist", desc: "We provide a tailored checklist of required documents specific to your visa type and destination.", duration: "Day 1–2" },
  { num: "03", title: "Application Preparation", desc: "Our team prepares and reviews your complete application to ensure zero errors before submission.", duration: "Day 2–5" },
  { num: "04", title: "Submission", desc: "We submit your application to the relevant embassy, consulate, or immigration authority.", duration: "Day 5–7" },
  { num: "05", title: "Tracking & Follow-Up", desc: "We actively track your application status and manage any additional requests from authorities.", duration: "Ongoing" },
  { num: "06", title: "Visa / Passport Delivery", desc: "Upon approval, we arrange collection or delivery of your visa or passport.", duration: "Final stage" },
];

const FAQS = [
  { q: "What types of visas does 111 Group handle?", a: "We handle tourist, visit, business, transit, student, long-stay, and investor visa applications across 40+ destinations." },
  { q: "How long does a tourist visa take?", a: "Processing times vary by destination. UAE tourist visas can be issued in 3–5 working days. Schengen visas typically take 15 working days." },
  { q: "Can 111 Group handle Schengen visa applications?", a: "Yes. We manage Schengen visa applications on behalf of UAE residents, including appointment booking, document preparation, and submission." },
  { q: "Do you offer passport renewal services?", a: "Yes. We assist with UAE and international passport renewals, including document collection, embassy liaison, and pickup services." },
  { q: "What if my visa is rejected?", a: "We will review the grounds for rejection and advise on appeal or reapplication. We have extensive experience handling refusals for major jurisdictions." },
];
...
export default function PassportVisaPage() {
  ...
  return (
    <>
      <Modal overlayRef={modal.overlayRef} contentRef={modal.contentRef} close={modal.close} title="Passport & Visa Applications" />
      <section className="relative min-h-[72vh] flex flex-col justify-end overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/brand/images/expandable-cards/legal.jpg" alt="Passport & Visa" fill className="object-cover object-center" priority />
        ...
        <div className="relative mx-auto w-full max-w-[1440px] px-6 lg:px-10 pb-16 pt-40">
          <div className="flex items-center gap-2 text-[0.67rem] text-white/50 mb-6">
            ...
            <span className="text-white/80">Passport & Visa Applications</span>
          </div>
          <div className="max-w-2xl">
            ...
            <h1 className="font-display text-[clamp(2.4rem,5.5vw,4.2rem)] font-semibold leading-[1.05] tracking-[-0.02em] text-white mb-5">
              Passport & Visa<br/>Applications, Handled.
            </h1>
            <p className="text-[1rem] text-white/65 leading-relaxed max-w-lg">
              Professional processing of all passport renewals and visa applications — tourist, business, transit, and long-stay — with priority options available.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10 py-14 lg:py-20">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_300px]">
            <div className="flex flex-col gap-16 min-w-0">
              <section id="benefits">
                <p className="eyebrow eyebrow-gold mb-2">What We Handle</p>
                <h2 className="font-display text-[clamp(1.6rem,3vw,2.4rem)] font-semibold leading-tight tracking-[-0.02em] text-fg mb-3">Our Visa & Passport Services</h2>
                <p className="text-[0.88rem] text-fg-soft max-w-xl leading-relaxed mb-8">Full-service handling of all visa categories and passport documentation.</p>
              ...
              <section id="steps">
                ...
                <p className="text-[0.88rem] text-fg-soft max-w-xl leading-relaxed mb-10">From consultation to visa in hand.</p>
            ...
            <aside className="flex flex-col gap-5 lg:sticky lg:top-28 lg:self-start">
              ...
              <div className="rounded-2xl bg-bg-elev p-5">
                ...
                <nav className="flex flex-col gap-0.5">
                  {[{ href: "#benefits", label: "Our Services" }, { href: "#steps", label: "Steps & Procedure" }, { href: "#faq", label: "FAQ" }].map((item) => (
              ...
              <div className="rounded-2xl bg-[color:var(--color-brand)]/10 border border-[color:var(--color-brand)]/20 p-5">
                ...
                <p className="text-[0.76rem] text-fg-soft leading-relaxed mb-4">Speak with a certified advisor — free and no commitment.</p>

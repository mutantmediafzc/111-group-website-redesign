...
const PROGRAMS = [
  { country: "UAE", flag: "🇦🇪", image: "/brand/images/country-images/uae.png", tag: "Golden Visa", minInvestment: "AED 2M", processing: "2–4 weeks", duration: "10 years", highlights: ["10-year renewable residency", "Covers spouse & children", "No sponsor required", "Full property ownership"] },
  { country: "Portugal", flag: "🇵🇹", image: "/brand/images/country-images/dominica.png", tag: "NHR", minInvestment: "€ 500,000", processing: "3–6 months", duration: "5 years", highlights: ["NHR tax regime (10% flat rate)", "EU Schengen freedom", "Path to citizenship after 5 years", "Property investment eligible"] },
  { country: "Greece", flag: "🇬🇷", image: "/brand/images/country-images/grenada.png", tag: "Golden Visa", minInvestment: "€ 250,000", processing: "2–4 months", duration: "5 years", highlights: ["Lowest investment threshold in EU", "Full Schengen access", "No minimum stay required", "Family included"] },
  { country: "Jordan", flag: "🇯🇴", image: "/brand/images/country-images/jordan.png", tag: "Residency", minInvestment: "USD 150,000", processing: "1–3 months", duration: "3 years", highlights: ["Business or real estate route", "Renewable residency", "Pathway to citizenship", "Strategic Middle East hub"] },
];

const BENEFITS = [
  { icon: "🏠", title: "Long-Term Security", desc: "Secure renewable residency for 5–10 years without the need to surrender your current citizenship." },
  { icon: "🌍", title: "Global Mobility", desc: "Gain access to Schengen, UAE, and regional travel benefits depending on your chosen jurisdiction." },
  { icon: "👨‍👩‍👧‍👦", title: "Family Coverage", desc: "Include your spouse, dependent children, and in some programs, parents under a single application." },
  { icon: "💼", title: "Business Access", desc: "Operate businesses, open bank accounts, and invest freely in your residency country." },
  { icon: "🏫", title: "Education & Healthcare", desc: "Access world-class public education and healthcare facilities in EU and GCC countries." },
  { icon: "🔄", title: "Citizenship Pathway", desc: "Many residency programs offer a clear path to full citizenship after meeting minimum stay requirements." },
];

const STEPS = [
  { num: "01", title: "Free Consultation", desc: "We assess your profile, goals, and budget to recommend the optimal residency program.", duration: "Day 1" },
  { num: "02", title: "Program Selection", desc: "We present tailored options with investment routes, timelines, and tax implications for each jurisdiction.", duration: "Week 1" },
  { num: "03", title: "Document Preparation", desc: "Our legal team collects, authenticates, and translates all required documents for submission.", duration: "Week 2–4" },
  { num: "04", title: "Investment Execution", desc: "We coordinate the qualifying investment — whether real estate, funds, or business setup.", duration: "Week 3–6" },
  { num: "05", title: "Application Submission", desc: "We submit a complete, error-free application package directly to the relevant authority.", duration: "Week 6–8" },
  { num: "06", title: "Permit Issuance", desc: "Upon approval, we coordinate permit collection, bank account opening, and relocation support.", duration: "Final stage" },
];

const FAQS = [
  { q: "What is the minimum investment for residency by investment?", a: "It varies by country. UAE Golden Visa starts at AED 2M in real estate. Greece starts at €250,000. Portugal requires €500,000. Jordan from USD 150,000." },
  { q: "Do I have to live in the country full time?", a: "Most RBI programs have minimal or no minimum stay requirements. UAE Golden Visa requires visiting at least once every 6 months. Portugal requires 7 days/year." },
  { q: "Can I get citizenship through residency by investment?", a: "Yes. Portugal, Greece, and Jordan all offer a pathway to citizenship after holding residency for the required period (typically 5 years)." },
  { q: "Will I be taxed on my worldwide income?", a: "Tax implications vary. Portugal's NHR regime offers a 10% flat tax. UAE has zero income tax. Our advisors will guide you on the optimal structure for your situation." },
  { q: "How long does the process take?", a: "UAE Golden Visa can be issued in 2–4 weeks. European programs typically take 2–6 months. 111 Group manages every step to minimise delays." },
];

const COUNTRIES = ["Afghanistan","Albania","Algeria","Andorra","Angola","Argentina","Armenia","Australia","Austria","Azerbaijan","Bahrain","Bangladesh","Belarus","Belgium","Bolivia","Bosnia","Brazil","Bulgaria","Cambodia","Canada","Chile","China","Colombia","Croatia","Egypt","Finland","France","Germany","Ghana","Greece","Hungary","India","Indonesia","Iran","Iraq","Ireland","Israel","Italy","Japan","Jordan","Kenya","Kuwait","Lebanon","Malaysia","Mexico","Morocco","Netherlands","New Zealand","Nigeria","Norway","Oman","Pakistan","Palestine","Philippines","Poland","Portugal","Qatar","Romania","Russia","Saudi Arabia","Singapore","South Africa","South Korea","Spain","Sri Lanka","Sweden","Switzerland","Syria","Turkey","Ukraine","United Arab Emirates","United Kingdom","United States","Vietnam"];
    ...
    <div ref={overlayRef} className="fixed inset-0 z-[200] hidden items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div ref={contentRef} className="relative flex w-full max-w-[860px] overflow-hidden rounded-2xl shadow-2xl" style={{ maxHeight: "88vh" }}>
        <div className="relative hidden md:flex w-[38%] shrink-0 flex-col overflow-hidden bg-[#111316]">
          <Image src="/brand/images/expandable-cards/legal.jpg" alt="" fill sizes="340px" className="object-cover opacity-55" />
          ...
          <div className="relative mt-auto p-8">
            ...
            <p className="mt-2 text-[0.76rem] text-white/50 leading-relaxed">Our advisors will respond within 24 hours with a full cost breakdown.</p>
          </div>
        </div>
        <div className="flex flex-1 flex-col overflow-y-auto bg-[#1C1F22] px-8 py-10">
          ...
          <div className="mb-7">
            <p className="text-[0.65rem] font-semibold uppercase tracking-[0.2em] text-[color:var(--color-brand)] mb-1">Residency by Investment</p>
            <h2 className="text-[1.55rem] font-semibold leading-tight text-white">Pricing Request</h2>
            <p className="mt-1.5 text-[0.78rem] font-light text-white/45">Fill in your details and we&apos;ll send a full quote tailored to your situation.</p>
          </div>
    ...
    <>
      ...
      <section className="relative min-h-[72vh] flex flex-col justify-end overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/brand/images/expandable-cards/legal.jpg" alt="Residency by Investment" fill className="object-cover object-center" priority />
        ...
        <div className="relative mx-auto w-full max-w-[1440px] px-6 lg:px-10 pb-16 pt-40">
          <div className="flex items-center gap-2 text-[0.67rem] text-white/50 mb-6">
            ...
            <span>/</span>
            <span className="text-white/80">Residency by Investment</span>
          </div>
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
            <div className="max-w-2xl">
              <div className="flex items-center gap-2 mb-4">
                <span className="text-[color:var(--color-brand)]">✦</span>
                <span className="text-[0.68rem] font-semibold uppercase tracking-[0.22em] text-white/60">Residency by Investment</span>
              </div>
              <h1 className="font-display text-[clamp(2.4rem,5.5vw,4.2rem)] font-semibold leading-[1.05] tracking-[-0.02em] text-white mb-5">
                Secure Long-Term<br/>Residency Through Investment.
              </h1>
              <p className="text-[1rem] text-white/65 leading-relaxed max-w-lg">
                Obtain long-term residency in the UAE, EU, or beyond through qualifying real estate, business, or fund investments — without surrendering your current citizenship.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-3 lg:grid-cols-1 lg:min-w-[200px]">
              {[{ val: "4", label: "Programs" }, { val: "2 weeks", label: "Fastest (UAE)" }, { val: "10 yrs", label: "Max Duration" }, { val: "100%", label: "Certified" }].map((s) => (
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_300px]">
            <div className="flex flex-col gap-16 min-w-0">
              ...
              <section id="programs">
                ...
                <h2 className="font-display text-[clamp(1.6rem,3vw,2.4rem)] font-semibold leading-tight tracking-[-0.02em] text-fg mb-3">Choose Your Residency Destination</h2>
                <p className="text-[0.88rem] text-fg-soft max-w-xl leading-relaxed mb-7">From UAE Golden Visa to European golden visa programs — we manage every step from investment to permit issuance.</p>
                    ...
                    <div key={p.country} className="group rounded-2xl bg-bg-elev overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
                      ...
                      <div className="p-6">
                        <div className="grid grid-cols-3 gap-2 mb-5">
                          {[{ label: "Min. Investment", val: p.minInvestment }, { label: "Processing", val: p.processing }, { label: "Duration", val: p.duration }].map((stat) => (
              ...
              {/* Benefits */}
              <section id="benefits">
                <p className="eyebrow eyebrow-gold mb-2">Why Residency by Investment?</p>
                <h2 className="font-display text-[clamp(1.6rem,3vw,2.4rem)] font-semibold leading-tight tracking-[-0.02em] text-fg mb-3">Benefits of Securing Residency Abroad</h2>
                <p className="text-[0.88rem] text-fg-soft max-w-xl leading-relaxed mb-8">A second residency expands your lifestyle, protects your family, and opens up global business opportunities.</p>
              ...
              <section id="steps">
                ...
                <p className="text-[0.88rem] text-fg-soft max-w-xl leading-relaxed mb-10">From first consultation to permit in hand — 111 Group manages every step with complete transparency.</p>
            ...
            <aside className="flex flex-col gap-5 lg:sticky lg:top-28 lg:self-start">
              <div className="rounded-2xl bg-bg-elev p-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <SidebarBtn onClick={() => quoteModal.open()} label="Ask for Quotation" sub="Get pricing details" icon={<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>} />
              ...
              <div className="rounded-2xl bg-bg-elev p-5">
                ...
                <nav className="flex flex-col gap-0.5">
                  {[{ href: "#programs", label: "Programs" }, { href: "#benefits", label: "Benefits" }, { href: "#steps", label: "Steps & Procedure" }, { href: "#faq", label: "FAQ" }].map((item) => (
              ...
              <div className="rounded-2xl bg-[color:var(--color-brand)]/10 border border-[color:var(--color-brand)]/20 p-5">
                ...
                <p className="text-[0.76rem] text-fg-soft leading-relaxed mb-4">Speak with a certified 111 Group advisor. We&apos;ll recommend the best residency program for your goals and budget.</p>

...
const BENEFITS = [
  { icon: "👨‍👩‍👧", title: "Family Sponsorship", desc: "Sponsor your spouse, children, and dependents for UAE or international residency with full legal support." },
  { icon: "💼", title: "Employment Visas", desc: "End-to-end processing of work permits and employment visas for individuals and corporate clients." },
  { icon: "🏦", title: "Investor Visas", desc: "We facilitate investor visa applications for UAE free zones, mainland, and international jurisdictions." },
  { icon: "🔄", title: "Status Renewals", desc: "Timely renewal of residence permits, entry visas, and work authorisations before expiry." },
  { icon: "🌍", title: "Multi-Country Filing", desc: "Simultaneous processing for multiple jurisdictions, ideal for mobile professionals and families." },
  { icon: "⚖️", title: "Legal Representation", desc: "Certified legal representatives handle all government liaison, hearings, and compliance matters on your behalf." },
];

const STEPS = [
  { num: "01", title: "Initial Consultation", desc: "We review your immigration needs, assess your current status, and outline the most efficient pathway forward.", duration: "Day 1" },
  { num: "02", title: "Document Collection", desc: "We provide a personalised checklist and collect, review, and certify all required documents.", duration: "Week 1–2" },
  { num: "03", title: "Application Preparation", desc: "Our legal team prepares and reviews a complete, compliant application package ready for submission.", duration: "Week 2–3" },
  { num: "04", title: "Government Submission", desc: "We submit directly to relevant immigration authorities and track your case status in real time.", duration: "Week 3–4" },
  { num: "05", title: "Follow-Up & Liaison", desc: "We actively follow up with authorities and address any queries or additional document requests.", duration: "Ongoing" },
  { num: "06", title: "Visa / Permit Issuance", desc: "Upon approval, we coordinate collection, biometrics if required, and any post-approval steps.", duration: "Final stage" },
];

const FAQS = [
  { q: "What immigration services does 111 Group provide?", a: "We cover the full spectrum: family sponsorship, employment visas, investor visas, student visas, status changes, renewals, and long-term residency processing in the UAE and internationally." },
  { q: "How long does a UAE residence visa take?", a: "Standard UAE employment or family visas typically take 2–4 weeks. Golden Visa and investor visas can be processed in 2–4 weeks with the correct documents." },
  { q: "Can 111 Group assist with visa status changes?", a: "Yes. We handle in-country status changes, entry permit conversions, and residency amendments for individuals and corporate clients." },
  { q: "Do you handle immigration for companies?", a: "Absolutely. We provide end-to-end corporate immigration services including employee work permit quotas, establishment card renewals, and compliance advisory." },
  { q: "What happens if a visa is rejected?", a: "Our team will assess the grounds for rejection and advise on the appeal process or alternative pathways. We have extensive experience handling rejections and reapplications." },
];
...
export default function ImmigrationServicesPage() {
  ...
  return (
    <>
      <ContactModal overlayRef={modal.overlayRef} contentRef={modal.contentRef} close={modal.close} title="Immigration Services" />

      <section className="relative min-h-[72vh] flex flex-col justify-end overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/brand/images/expandable-cards/legal.jpg" alt="Immigration Services" fill className="object-cover object-center" priority />
        ...
        <div className="relative mx-auto w-full max-w-[1440px] px-6 lg:px-10 pb-16 pt-40">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="font-display text-[clamp(2.4rem,5.5vw,4.2rem)] font-semibold leading-[1.05] tracking-[-0.02em] text-white mb-5">
              End-to-End Immigration<br/>Assistance.
            </h1>
            <p className="text-[1rem] text-white/65 leading-relaxed max-w-lg">
              From family sponsorship to investor visas, 111 Group manages your immigration process with precision, speed, and complete legal compliance.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_300px]">
            <div className="flex flex-col gap-16 min-w-0">
              ...
              <section id="benefits">
                ...
                <h2 className="font-display text-[clamp(1.6rem,3vw,2.4rem)] font-semibold leading-tight tracking-[-0.02em] text-fg mb-3">Comprehensive Immigration Coverage</h2>
                <p className="text-[0.88rem] text-fg-soft max-w-xl leading-relaxed mb-8">From individual visas to complex corporate immigration — our certified team handles it all.</p>
              ...
              <section id="steps">
                ...
                <p className="text-[0.88rem] text-fg-soft max-w-xl leading-relaxed mb-10">A streamlined, transparent process from consultation to visa issuance.</p>
            ...
            <aside className="flex flex-col gap-5 lg:sticky lg:top-28 lg:self-start">
              ...
              <div className="rounded-2xl bg-bg-elev p-5">
                ...
                <nav className="flex flex-col gap-0.5">
                  {[{ href: "#benefits", label: "What We Handle" }, { href: "#steps", label: "Steps & Procedure" }, { href: "#faq", label: "FAQ" }].map((item) => (
              ...
              <div className="rounded-2xl bg-[color:var(--color-brand)]/10 border border-[color:var(--color-brand)]/20 p-5">
                ...
                <p className="text-[0.76rem] text-fg-soft leading-relaxed mb-4">Speak with a certified 111 Group advisor about your immigration needs — no commitment.</p>
